...
def variational_sweep(H, initial, sector, constraint = None,
                      ...
                      min_sweeps=2, max_sweeps = 100, k=1, sector_mult=1):
    ...
    try:
        ...
        print('Could not move into right canonical form')
    ...
    while cont or sweeps < min_sweeps:
        ...
        if sweeps != 0:
            relativediff = np.abs((Hexp-lastHexp) / Hexp)
